...
INPUT_FILE = r"Textual_200.jsonl"
OUTPUT_FILE = r"answer-textual-gpt-4o-mini.jsonl"
...
def main():
    ...
    print(f"✅ All problems have been processed, and the output has been written to：{OUTPUT_FILE}")
